<%@ Page Title="" Language="C#" MasterPageFile="~/MuBanYe/XiTong.Master" AutoEventWireup="true" CodeBehind="XiuGaiMiMa.aspx.cs" Inherits="WebApplication1.XiTong.GeRenZhongXin.XiuGaiMiMa" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- 引入jQuery -->
	<script type="text/javascript" src="/XiTong/js/jquery-3.3.1.min.js"></script>
    <link href="/XiTong/css/XiuGaiMiMa.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="xiu-gai-mi-ma">
        ...
        <div class="mi-ma-xin-xi-qu">
            ...
            <div class="mi-ma-xiang-mu">
                ...
                <asp:TextBox ID="WenBenDangQianMiMa" runat="server" 
                    TextMode="Password" CssClass="mi-ma-shu-ru-kuang"
            ...
            <div class="mi-ma-xiang-mu">
                ...
                <asp:TextBox ID="WenBenXinMiMa" runat="server" 
                    TextMode="Password" CssClass="mi-ma-shu-ru-kuang"
            ...
            <div class="mi-ma-xiang-mu">
                ...
                <asp:TextBox ID="WenBenQueRenMiMa" runat="server" 
                    TextMode="Password" CssClass="mi-ma-shu-ru-kuang"
        ...
        <div style="text-align: center; margin-top: 20px;">
            <a href="/XiTong/GeRenZhongXin/GeRenXinXi.aspx" class="fan-hui-lian-jie">← 返回个人中心</a>
        </div>
    </div>
    ...
    // 实时验证：当用户输入时清除错误提示
    $('#<%= WenBenDangQianMiMa.ClientID %>, #<%= WenBenXinMiMa.ClientID %>, #<%= WenBenQueRenMiMa.ClientID %>').on('input', function () {
        var $this = $(this);
