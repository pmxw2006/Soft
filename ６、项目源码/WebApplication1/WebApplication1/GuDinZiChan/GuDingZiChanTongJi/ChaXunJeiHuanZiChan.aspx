<%@ Page Title="" Language="C#" MasterPageFile="~/MuBanYe/GuDinZiChan.Master" AutoEventWireup="true" CodeBehind="ChaXunJeiHuanZiChan.aspx.cs" Inherits="WebApplication1.GuDinZiChan.GuDingZiChanTongJi.ChaXunJeiHuanZiChan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="BiaoDan">
        ...
        <tr>
            ...
            <td>
                <span class='<%# Eval("LeiXing").ToString() == "借出" ? "ZhuangTaiJieChu" : "ZhuangTaiGuiHuan" %>'>
                    <%# Eval("LeiXing") %>
                </span>
            </td>
        </tr>
