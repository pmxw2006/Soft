<%@ Page Title="" Language="C#" MasterPageFile="~/MuBanYe/GuDinZiChan.Master" AutoEventWireup="true" CodeBehind="GeRenXinXi.aspx.cs" Inherits="WebApplication1.GuDinZiChan.GeRenZhongXin.GeRenXinXi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
	<!-- 引入jQuery -->
	<script type="text/javascript" src="/XiTong/js/jquery-3.3.1.min.js"></script>
    <link href="/GuDinZiChan/css/GeRenXinXi.css" rel="stylesheet" />
</asp:Content>
	...
	<div class="ge-ren-zhong-xin">
		...
		<div class="xin-xi-qu">
			<div class="xin-xi-biao-ti">账户信息
				<a href="/GuDinZiChan/GeRenZhongXin/XiuGaiMiMa.aspx" class="tiao-zhuan-lian-jie" title="跳转到修改密码页面">修改密码</a>
			</div>
			<div class="xin-xi-wang-ge">
				<div class="xin-xi-xiang-mu">
					<span class="xin-xi-biao-qian">用户账号</span>
					<asp:TextBox ID="WenBenYongHuZhangHao" runat="server" CssClass="xin-xi-zhi zhi-du" ReadOnly="true">
					</asp:TextBox>
				</div>

				<div class="xin-xi-xiang-mu">
					<span class="xin-xi-biao-qian">用户名</span>
					<asp:TextBox ID="WenBenYongHuMing" runat="server" CssClass="bian-ji-kuang" MaxLength="50"
						Enabled="false"></asp:TextBox>
				</div>

				<div class="xin-xi-xiang-mu">
					<span class="xin-xi-biao-qian">所属部门</span>
					<asp:TextBox ID="WenBenBuMen" runat="server" CssClass="xin-xi-zhi zhi-du" ReadOnly="true">
					</asp:TextBox>
				</div>
			</div>
		</div>
		...
		<div class="xin-xi-qu">
			...
			<div class="xin-xi-wang-ge">
				<div class="xin-xi-xiang-mu">
					...
					<asp:TextBox ID="WenBenXingMing" runat="server" CssClass="bian-ji-kuang" MaxLength="20"
						Enabled="false"></asp:TextBox>
				</div>

				<div class="xin-xi-xiang-mu">
					<span class="xin-xi-biao-qian">身份证号码</span>
					<asp:TextBox ID="WenBenShenFenZheng" runat="server" CssClass="xin-xi-zhi zhi-du" ReadOnly="true"
		...
		<div class="an-niu-zu">
			...
			<asp:Button ID="AnNiuBaoCun" runat="server" Text="保存修改" CssClass="an-niu-cheng-gong"
				style="display: none;" OnClick="AnNiuBaoCun_Click" />
